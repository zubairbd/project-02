                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="float-right m-0">
                            <a href="{{route('admin.admins.index')}}" class="btn btn-primary btn-sm"><i class="fa fas-"></i>&nbsp; All Users</a>
                        </p>
                    </div>
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                <div class="col col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Enter Your Admin Name">
                                </div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="form-actions form-group">
                                <button type="submit" class="btn btn-secondary btn-sm">Save Admin</button>
                            </div>
                        </div>
                    </form>
                </div>

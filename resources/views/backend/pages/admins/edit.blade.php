                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="float-right m-0">
                            <a href="{{route('admin.admins.index')}}" class="btn btn-primary btn-sm"><i class="fa fas-"></i>&nbsp; All Admin</a>
                        </p>
                    </div>
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col col-md-6">
                                    ...
                                    <input type="text" name="email" value="{{$admin->email}}" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-6">
